    ...
    return (
        <div className='w-full py-28'>
            ...
            <div className='w-full flex justify-center items-center py-0 px-20 sm:px-10 md:px-6'>
                <div className='w-full max-w-[800px] lg:max-w-[1200px] bg-secondary py-16 sm:py-8 rounded-[7px] border border-tertiary grid grid-cols-1 sm:grid-cols-2 gap-y-20 sm:gap-y-8 md:gap-y-0 md:flex justify-evenly'>
                    {
