...
const Hero = () => {
  return (
    <section
      ...
      className={`min-h-[70vh] bg-cover md:bg-top relative w-full bg-[url('/src/assets/about/about_hero.png')] bg-bottom bg-opacity-60`}
    >
      <Header />

      <div className=" absolute inset-0 flex items-center pb-24 w-[80%] mx-auto">
